...
public class TitaniumRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TitaniumItems.TITANIUM_INGOT.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, "titanium_nugget_from_ingot"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TitaniumItems.TITANIUM_NUGGET.get(), 9)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, "titanium_ingot_from_nugget"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_HELMET.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_HELMET.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_CHESTPLATE.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_CHESTPLATE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_LEGGINGS.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_LEGGINGS.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_BOOTS.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_BOOTS.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_SWORD.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_SWORD.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TitaniumItems.TITANIUM_PICKAXE.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_PICKAXE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TitaniumItems.TITANIUM_SHOVEL.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_SHOVEL.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TitaniumItems.TITANIUM_AXE.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_AXE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TitaniumItems.TITANIUM_HOE.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_HOE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TitaniumItems.TITANIUM_HORSE_ARMOR.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Titanium.MOD_ID, getItemName(TitaniumItems.TITANIUM_HORSE_ARMOR.get())));
